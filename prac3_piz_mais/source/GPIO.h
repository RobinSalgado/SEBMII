...
/********************************************************************************************/
/*!
 	 \brief	 PORT A interrupt handler. It must indicate the signal generator to change states.
 	 \return void
 */
...
/*!
 	 \brief
 	 	 This function configures different characteristics in a specific GPIO:
 	 ...
 	 \param[in]  PinValue Pointer to a constant configuration value that configures the pin characteristics. In particular this function
 	 uses the definitions GPIO_PS, GPIO_PE, GPIO_MUX1 etc.
 	 \return void
...
/*!
 	 \brief
 	 	 This function configures all the GPIO port as input when 1 logic is written or output when 0 logic is written.
...
/********************************************************************************************/
/*!
 	 \brief  This function configures specific pins of a GPIO port as input when 1 logic is written or output when 0 logic is written.
 	 \param[in] portName Port to configure.
...
/*!
 	 ...
 	 \param[in] portName Port to read.
...
/*!
 	 ...
 	 \param[in] portName Port to write.
...
/********************************************************************************************/
/*!
 	\brief This function sets a specific pin in a GPIO port.
...
/********************************************************************************************/
/*!
 	 \brief This function clears a specific pin in a GPIO port.
...
/********************************************************************************************/
/*!
 	 \brief This function toggles the value of a specific pin in a GPIO port.
 	 \param[in] portName Selected Port.
